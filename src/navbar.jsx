...
const Navbar = () => {
  ...
  return (
   ...
   <nav className="navbar bg-dark navbar-expand-lg bg-body-tertiary container-fluid sticky-top" data-bs-theme="dark">
      <div className="container-fluid">
        <Link className="navbar-brand color-theme" to="/"><img src={VIOLETBLUELOGO} width={55} alt="" /> <span className='ml-0 p-1'>BASWETI</span> </Link>
