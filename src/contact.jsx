  ...
  return (
    <div className="container py-5 text-light">
      <div className="text-center mb-5">
        ...
        <p className="lead">
          Let's connect and collaborate! Reach out for projects, collaborations,
          or just to say hi.
        </p>
      ...
      <div className="row">
        <div className="col-md-5 mb-4">
          <div className="bg-dark p-4 rounded-4 shadow-lg">
            <h4 className="mb-4 text-theme" style={{ color: "#6A56FF" }}>
              Contact Details
            </h4>
            <p>
              <FaEnvelope className="me-2" /> michaelbasweti@gmail.com.com
            </p>
            <p>
              <FaPhoneAlt className="me-2" /> +254 701 981 241
            </p>
            <p>
              <FaMapMarkerAlt className="me-2" /> Nairobi, Kenya
            </p>
            <div className="mt-4">
              <a
                href="https://www.linkedin.com/in/michael-basweti"
          ...
          <div className="bg-dark p-4 rounded-4 shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                style={{ backgroundColor: "#6A56FF", border: "none" }}
              >
                Send Message
              </button>
            </form>
